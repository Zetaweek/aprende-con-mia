...
const styles = StyleSheet.create({
    ...
    title: { fontSize: 52, fontFamily: 'Nunito_800ExtraBold', color: '#7E22CE', marginBottom: 8 },
    subtitle: { fontSize: 22, fontFamily: 'Nunito_400Regular', color: '#A855F7', marginBottom: 40 },
    btn: {
    ...
    btnText: { fontSize: 28, fontFamily: 'Nunito_700Bold', color: '#fff' },
});